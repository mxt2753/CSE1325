...
public void displayDetails(Object item) {
    ...
    if (item instanceof Customer) {
        filename = ((Customer) item).getFilename().toString();
    } else if (item instanceof Option) {
        filename = ((Option) item).getFilename().toString();
    } else if (item instanceof Computer) {
        filename = ((Computer) item).getFilename().toString();
    }
    ...
    if (filename != null) {
        ...
        display.setText("No image available");
    }
}
/*
    if (item instanceof Customer) {
        filename = ((Customer) item).getFilename();
    } else if (item instanceof Option) {
        filename = ((Option) item).getFilename();
    } else if (item instanceof Computer) {
        filename = ((Computer) item).getFilename();
    }
